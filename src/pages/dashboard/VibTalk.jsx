...
//////////////////////////////////////////////////////////
 useEffect(() => {
  ...
  // const usersToShow = filteredUsers !== null ? filteredUsers : users ||[];
  const usersToShow = Array.isArray(filteredUsers)
  ? filteredUsers
  : Array.isArray(users)
    ? users
    : [];
        ...
        {selectedUser ? (
          ...
          >
            ...
            <Typography variant="body1" sx={{ color: 'text.secondary', mb: 3, maxWidth: 440 }}>
              {loggedInUser ?
                `Keep your phone connected to use VibeTalkon your computer. Select a chat to start messaging.` :
                'Please log in to start using VibeTalkWeb.'
              }
            </Typography>
            {isMobile && (
              <Button
